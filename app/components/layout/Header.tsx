  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 glass-dark border-b border-white/5">
      <div className="flex items-center justify-between px-6 py-3">
        <Link href="/" className="flex items-center gap-2" aria-label="Claw Poker Home">
      ...
      {/* Mobile menu */}
      {menuOpen && (
        <nav id="mobile-nav" className="md:hidden glass-dark border-t border-white/5 px-4 pb-4" aria-label="Mobile navigation">
